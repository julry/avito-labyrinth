...
export const TargetedPart = () => {
    ...
    return (
        <AnimatePresence>
            ...
            <Content $ratio={ratio}>
                <ButtonWrapper>
                    <Button type={part === 0 ? 'main' : 'secondary'} onClick={() => setPart(0)}>
                        Еженедельные розыгрыши
                    </Button>
                    <Button type={part === 1 ? 'main' : 'secondary'} onClick={() => setPart(1)}>
                        Розыгрыш{'\n'}главного приза
                    </Button>
                </ButtonWrapper>
                <PointsWrapper>
