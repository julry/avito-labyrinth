                ...
                <IdWrapper $ratio={ratio}>
                    ...
                    <SvgWrapper>
                        <svg width="100%" height="100%" viewBox="0 0 147 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.50014 5.18841C-1.99986 8.18841 2 37.6884 6.50014 45.1884C10 51.0213 68.4999 42.6884 109.5 45.1884C150.5 47.6884 145 45.1884 143.5 18.6884C142 -7.81163 90.4999 5.18841 71.9999 5.18841C53.4999 5.18841 19.0001 2.18841 8.50014 5.18841Z" stroke="#04E061" stroke-width="3"/>
                        </svg>
                    </SvgWrapper>
                </IdWrapper>
